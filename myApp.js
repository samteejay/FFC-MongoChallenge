...
var createAndSavePerson = function(done) {
  let p = new Person({ name: 'foo', age: 20, favoriteFoods: ['rice', 'beans', 'moimoi']});
  p.save((err, data) => err ? done(err) : done(null, data));
...
const arrayOfPeople = [
				{ name: 'Jon', age: 22, favoriteFoods: ['indomie', 'fish', 'moimoi']},
				{ name: 'Paul', age: 23, favoriteFoods: ['sharwama', 'burger', 'cheese']}]
